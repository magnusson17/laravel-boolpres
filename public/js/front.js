...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    sendForm: function sendForm() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('http://127.0.0.1:8000/api/messages', this.form).then(function (res) {
        _this.form.mail = '', _this.form.message = '', _this.alertMessage = 'Messaggio inviato';
      });
    }
  },
...
var render = function () {
  ...
  return _c(
    ...
    [
      _vm._v("\n    contact\n\n    "),
      _c("Alert", { attrs: { type: "sucsess", message: "alertMessage" } }),
      _vm._v(" "),
